    ...
    "UserPromptSubmit": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "python3 \"$HOME/.codex/skills/complexity-cli/scripts/check_complexity.py\" --baseline-hook",
            "timeout": 30
          }
        ]
      }
    ...
    "Stop": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "python3 \"$HOME/.codex/skills/complexity-cli/scripts/check_complexity.py\" --hook",
            "timeout": 120,
